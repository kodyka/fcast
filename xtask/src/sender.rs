...
impl SenderArgs {
    pub fn run(self) -> Result<()> {
        ...
        match self.cmd {
            SenderCommand::Android(_args) => anyhow::bail!(
                "The Android sender was extracted from this monorepo. Use the standalone \
                 repository at https://github.com/kodyka/fcast-android-sender instead."
            ),
            #[cfg(target_os = "windows")]
